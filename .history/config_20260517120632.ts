...
// ─── Environment toggle ──────────────────────────────────────────────────────
export const USE_PRELIVE = true; // set to false for production

// ─── Your app credentials (public — safe in mobile bundle) ───────────────────
export const CLIENT_ID = process.env.EXPO_PUBLIC_CLIENT_ID; // from QF Request Access
export const CLIENT_SECRET = process.env.EXPO_PUBLIC_CLIENT_SECRET; // from QF Request Access (only used on backend, never in mobile code)
...
export const BACKEND_BASE_URL = process.env.EXPO_PUBLIC_BACKEND_BASE; // e.g. https://myapp-backend.fly.dev
...
export const REDIRECT_URI = "https://node-1-41dg.onrender.com/oauth/callback"; // e.g. com.yourapp://oauth/callback
