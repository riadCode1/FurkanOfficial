...
import { getBookmarks,addBookmark, useQuranApi } from "../services/quranApi";
...
const Dropmenu = ({
  ...
  const saveToPlaylist = async (list) => {
    console.log("Saving to playlist:", list);
    setIsSaved(true);
  ...
  // ── Add a bookmark ─────────────────────────────────────────────────────────
  const addBookmark = async (verseNumber, key, mushafId ) => {
    console.log("Adding bookmark:", { verseNumber, key, mushafId });
  ...
  console.log("Bookmarks in Dropmenu:", bookmarks);
