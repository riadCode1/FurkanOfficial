  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {nextPrayer && (
          <ImageBackground source={require("../assets/images/bgTm.png")} style={{  }}>
        ...
        <View  style={{ alignItems: "center",backgroundColor:'rgba(0,0,0,0.3)', padding: 10, borderRadius: 8, marginTop: 24 }}>
          ...
          >
            {Object.entries(data)
               .filter((_, index) => [0, 2, 3, 5, 6].includes(index))
              .map(([name, time]) => (
                <View
                  key={name}
                  style={{
                ...
                >
                  ...
                  <Text style={styles.text}>{ time} {name === "Fajr" && "Dhuhr" ? " AM" : " PM"}</Text>
                </View>
              ))}
          </View>
        </View>
