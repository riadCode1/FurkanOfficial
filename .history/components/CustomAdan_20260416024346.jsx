  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ImageBackground source={require("../assets/images/nav bar.png")} style={{ alignItems: "center",backgroundColor:'rgba(0,0,0,0.3)', padding: 10, borderRadius: 8, marginTop: 24 }}>
