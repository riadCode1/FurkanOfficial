        ...
        {nextPrayer && (
          ...
          <View style={{ alignItems: "center", marginBottom: 5 }}>
            <Text style={styles.nextTitle}>
              {languages
                ? `${prayerNames[nextPrayer.name] || nextPrayer.name} ${data[nextPrayer.name]} ${data["Fajr"] === nextPrayer.name ? "AM": "PM"} am `
                : `${nextPrayer.name} ${data[nextPrayer.name]}`|| ` ${data[nextPrayer.name] === "Fajr" ? "AM": "PM"} am`}
            </Text>
