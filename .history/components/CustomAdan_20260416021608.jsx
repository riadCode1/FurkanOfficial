  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View  style={{ alignItems: "center",backgroundColor:'rgba(0,0,0,0.3)', padding: 10, borderRadius: 8 }}>
          ...
          >
            {Object.entries(data)
              .splice([5, 6, 7, 8, 9, 10].includes(Object.keys(data).indexOf) ? 5 && 2 : 0 && 2)
              .map(([name, time]) => (
                <View
                  key={name}
                  style={{
...
const styles = StyleSheet.create({
  ...
  countdown: {  fontSize: 10, color:'rgba(255,255,255,0.9)', },
});
