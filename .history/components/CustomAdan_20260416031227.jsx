...
export default function PrayerTimes() {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
      contentFit="fill"
        source={nextPrayer.name === "Fajr" || nextPrayer.name === "Dhuhr"
          ? require("../assets/images/fajr_bg.png")
          : nextPrayer.name === "Asr"
          ? require("../assets/images/asr_bg.png")
          : nextPrayer.name === "Maghrib"
          ? require("../assets/images/maghrib_bg.png")
          : nextPrayer.name === "Isha"
          ? require("../assets/images/isha_bg.png")
          : nextPrayer.name === "Sunrise"
          ? require("../assets/images/sunrise_bg.png")
          : nextPrayer.name === "Sunset"
          ? require("../assets/images/sunset_bg.png")
          : require("../assets/images/default_bg.png")}
        style={{ borderRadius: 8, padding: 12, overflow: "hidden", width: "100%" }}
      >
        <TouchableOpacity
          onPress={() => prepare(setCurrentLocation)}
          style={{
