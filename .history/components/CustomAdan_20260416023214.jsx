  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ImageBackground contentFit="fill" source={require("../assets/images/bgTm.png")} style={{ alignItems: "center", width: "100%", height: "100%", padding: 10, borderRadius: 8, marginTop: 24 }}>
