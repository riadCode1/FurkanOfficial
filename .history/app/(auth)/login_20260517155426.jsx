...
const CLIENT_ID = "a9001320-ae9f-4138-96e6-9817f298670b"; // From your OAuth application
const REDIRECT_URI = "furkan://oauth/callback"; // Your Expo dev URL or custom scheme
const BACKEND_BASE_URL = "https://node-1-41dg.onrender.com";
const USE_PRELIVE = false; // set to false for production
...
export default function App() {
  ...
  const [request, response, promptAsync] = useAuthRequest(
    {
      clientId: CLIENT_ID,
     scopes: ["offline_access", "bookmark", "collection", "user"],
