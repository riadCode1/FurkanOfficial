    ...
    <View style={{ flex: 1 }}>
      ...
      {!isKeyboardVisible && (
        <View style={[styles.floatingContainer, { bottom: insets.bottom }]}>
          ...
          <BlurView
            intensity={85}           // 70-95 looks best for glass effect
            tint="white"              // 'light' | 'dark' | 'default'
            blurReductionFactor={4}   // Adjust for performance vs. blur quality
                       // 'dark' | 'light' | 'default'
...
const styles = StyleSheet.create({
  floatingContainer: {
    ...
    right: 0,
    height: 72,
    // backgroundColor removed → now handled by BlurView
    shadowColor: "#000",
    ...
    borderRadius: 50,
    borderWidth: 1,
    borderColor: "rgba(255,255,255,0.25)",   // subtle glass border
    marginVertical: 10,
    overflow: "hidden",
  },
