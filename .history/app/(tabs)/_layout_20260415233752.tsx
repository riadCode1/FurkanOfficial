...
export default function Layout() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <Tabs
        screenOptions={{
          ...
          tabBarStyle: {
            ...
            borderTopWidth: 0,
            elevation: Platform.OS === "android" ? 10 : 0,   // subtle shadow on Android
            backgroundColor: Platform.select({
              ios: "transparent",           // needed for blur
              android: "rgba(20, 20, 20, 0.92)",  // dark semi-transparent for Android
            }),
          },

          // Blur only on iOS - Android uses semi-transparent color
          tabBarBackground: () =>
            Platform.OS === "ios" ? (
              <BlurView
                tint="dark"          // Try: "dark", "light", "prominent"
                intensity={90}      // 70-95 looks good
      ...
      {/* Bottom Player - Keep it above the tab bar if needed */}
