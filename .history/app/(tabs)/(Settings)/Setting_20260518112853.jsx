  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={{  marginVertical: 20, alignItems: "center",textAlignment: "center" }} >
          <Text style={{ backgroundColor: "red",borderRadius: 100, textAlign: "center", color: "black", fontSize: 18, fontWeight: "bold"}}>
