        ...
        <View style={styles.header}>
          <Text style={styles.headerText}>
            {languages ? "إعدادات" : "Settings"}
                    ...
                    <Text style={{ backgroundColor: "white",borderRadius: 100, textAlign: "center", color: "black", fontSize: 18, fontWeight: "bold"}}>
                       {profile?.username[0] || "Guest"}
                       </Text>

        </View>

        <View className="divider" style={{ height: 1, backgroundColor: Colors.textGray, marginVertical: 20 }} />
