    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.header}>
          ...
          <Text style={{width: 10, backgroundColor: "white", padding: 10,borderRadius: 100, textAlign: "center", color: "black", fontSize: 18, fontWeight: "bold"}}> {profile?.username[0] || "Guest"}</Text>
