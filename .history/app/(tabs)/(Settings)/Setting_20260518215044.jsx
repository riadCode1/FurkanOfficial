...
const S = StyleSheet.create({
  ...
  // profile
  profileCard:    {  marginTop: 16, borderRadius: 14, overflow: "hidden", backgroundColor: "red", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", flexDirection: "row", alignItems: "center" },
  profileLeft:    { flex: 1 },
