  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={{backgroundColor: "lightgray",alignItems: "center", padding: 10, borderRadius: 5}}>
          <Text style={{color: "white", fontSize: 18, fontWeight: "bold"}}> {profile?.username[0] || "Guest"}</Text>
