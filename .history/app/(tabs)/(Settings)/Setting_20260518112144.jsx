  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={{alignItems: "center", justifyContent: "center", padding: 10, borderRadius: 5}}>
          <Text style={{backgroundColor: "white", padding: 10,borderRadius: 50, textAlign: "center", color: "black", fontSize: 18, fontWeight: "bold"}}> {profile?.username[0] || "Guest"}</Text>
