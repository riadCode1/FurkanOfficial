      ...
      <Tabs
        screenOptions={{
          ...
          tabBarButton: (props) => (
           <Pressable
            {...props}
            android_ripple={{ color: Colors.textGray }} // remove ripple (Android)
            style={({ pressed }) => [
              props.style,
              {
                opacity: pressed ? 0.5 : 1, // 👈 change touch effect here
                transform: [{ scale: pressed ? 0.95 : 1 }], // 👈 optional animation
              },
            ]}
          />
          ),
