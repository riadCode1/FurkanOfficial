...
export default function LoginScreen() {
 ...
 const handleGuest = () => {
  router.push("Index"); // change to your home screen
};
  return (
...
>
  <Text style={styles.guestButtonText}>
    Continue as Guest
      ...
      <Text style={{fontSize: 12, color: '#506068', textAlign: 'center', marginBottom: 10}}>
        © 2024 FurkanApp. All rights reserved.
      </Text>
      <Text style={{fontSize: 10, color: '#506068', textAlign: 'center'}}>
        Powered by Quran foundation</Text>
      </ImageBackground>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  registerButton: {
  backgroundColor: "#2E86FF", // modern blue
  borderRadius: 12,
  paddingVertical: 16,
  alignItems: "center",
  marginBottom: 14,
