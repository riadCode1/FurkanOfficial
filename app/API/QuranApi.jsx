...
export const AdanTimes = (id1,id2,id3) => id1 && id2 && id3 `${AdanTimes}/${id1}?latitude=${id2}&longitude=${id3}&method=2`
...
export const fetchAdanTime = (id1,id2,id3) => {
  return apicalls(AdanTimes(id1,id2,id3))
}
